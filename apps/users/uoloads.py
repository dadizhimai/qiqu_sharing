...
def image_upload(files, dir_name):
    # 允许上传文件类型
    allow_suffix = ['mp4', "wmv", "avi", "mpg", "asf", "rmvb",]
    file_suffix = files.name.split(".")[-1]
    if file_suffix not in allow_suffix:
        return {"error": 1, "message": "上传文件格式不正确"}
...
# 视频文件格式 avi、wmv、mpeg、mp4、mov、mkv、flv、f4v、m4v、rmvb、rm、3gp、dat、ts、mts、vob
