...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('contents', models.TextField(verbose_name='\u53d1\u8a00\u5185\u5bb9')),
                ('pid', models.IntegerField(verbose_name='\u7236id')),
                ('cid', models.IntegerField(verbose_name='\u5b50id')),
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='\u53d1\u5e03\u65f6\u95f4')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='\u8d34\u5427\u53d1\u8a00\u4eba')),
            ],
            options={
                'verbose_name': '\u8d34\u5427\u7559\u8a00',
                'verbose_name_plural': '\u8d34\u5427\u7559\u8a00',
            },
        ),
    ]
